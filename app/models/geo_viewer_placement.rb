...
# support the creation of geo viewers that represents other geo viewers.
#
# Attributes
#
# * +combined_geo_viewer_id+ - The ID of the combined geo viewer.
# * +eo_viewer_id+           - The ID of the geo viewer.
# * +toggled+                - Boolean that sets whether the layer should be
#                              toggled on the combined viewer by default
# * +toggable+               - Boolean that sets whether the layer can be turned
#                              on/off by a user.
