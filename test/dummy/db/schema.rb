...
ActiveRecord::Schema.define(version: 20160318155462) do
  ...
  create_table "nodes", force: :cascade do |t|
    ...
    t.float    "lat",                            index: {name: "index_nodes_on_lat_and_lng", with: ["lng"]}
    t.float    "lng"
    t.string   "location"
    ...
    t.integer  "pin_id",                         index: {name: "fk__nodes_pin_id"}, foreign_key: {references: "pins", name: "fk_nodes_pin_id", on_update: :no_action, on_delete: :no_action}
  ...
  create_table "geo_viewers", force: :cascade do |t|
    t.string   "title",           null: false
    t.text     "description"
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.datetime "deleted_at",      index: {name: "index_geo_viewers_on_deleted_at"}
  ...
  create_table "geo_viewer_placements", force: :cascade do |t|
    t.integer  "combined_geo_viewer_id", index: {name: "fk__geo_viewer_placements_combined_geo_viewer_id"}, foreign_key: {references: "geo_viewers", name: "fk_geo_viewer_placements_combined_geo_viewer_id", on_update: :no_action, on_delete: :no_action}
    t.integer  "geo_viewer_id",          index: {name: "fk__geo_viewer_placements_geo_viewer_id"}, foreign_key: {references: "geo_viewers", name: "fk_geo_viewer_placements_geo_viewer_id", on_update: :no_action, on_delete: :no_action}
